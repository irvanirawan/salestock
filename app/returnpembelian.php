...
<div class="box-primary box">
    <div class="box-header box text-center"> <h3>Return Pembelian</h3> </div>
    ...
    if (isset($_POST['cari_tr'])) {
        $idnya = $_POST['idnya'];
        $qcr = "SELECT detail_pembelian.id_transaksi, barang.id_barang, detail_pembelian.id, barang.nama_barang, detail_pembelian.jumlah from detail_pembelian left join barang on detail_pembelian.id_barang = barang.id_barang where id_transaksi='$idnya'";
        ...
        while ($datacari = mysqli_fetch_array($ex)) {
            ...
            <form method="post" enctype="multipart/form-data">
                <table class="table table-responsive">
                    <tr>
                    <input type="hidden" name="id[]" value="<?php echo $datacari['id']; ?>">
    ...
    <?php }
        if (isset($_POST['breturn'])) {
            ...
            for ($i = 0; $i < count($idbreturn); $i++) {
                ...
                $detail2 = "update detail_pembelian set jumlah=jumlah-'$Jml' where id='$Id_return'";
